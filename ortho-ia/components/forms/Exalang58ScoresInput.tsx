...
// Mapping des bandes Exalang vers la grille 5 zones alignée Exalang officiel
// (manuel Exalang 11-15 p. 65-67). Les bandes P75-95 et > P95 sont toutes
// "Moyenne haute" ; P25-75 est "Moyenne" ; P10-25 = "Zone de fragilité"
// (zone à surveiller manuel) ; P5-10 = "Difficulté" (seuil consensuel P10) ;
// < P5 = "Difficulté sévère" (seuil strict -1,65 σ).
