...
slug: crbo-aphasie-avc
canonicalSlug: crbo-aphasie-avc
locale: fr
...
author: Ortho.ia
coverImage: /blog-covers/crbo-aphasie-avc.png
coverAlt: >-
  CRBO aphasie post-AVC : modèle et tests recommandés
coverWidth: 940
coverHeight: 650
---
...
**Votre bilan d'aphasie post-AVC ne devrait jamais vous prendre trois heures de rédaction le soir.** Pourtant, c'est le CRBO le plus exigeant à rédiger en bilan adulte : il doit porter un diagnostic typologique précis (Broca, Wernicke, conduction, anomique, globale), articuler les scores de plusieurs batteries normées (MT-86, BDAE, DO-80, BREF), et tenir face à un contrôle a posteriori renforcé depuis la suppression de la DAP. Cet article donne la référence clinique complète : sélection raisonnée des tests selon le profil et la phase post-AVC, structure obligatoire du CRBO aphasie en six sections, et formulation de la conclusion typologique — y compris en situation de profil mixte ou atypique. Retrouvez la structure réglementaire complète dans notre [guide complet de la rédaction du CRBO](/guide-redaction-crbo/).

Si le bilan révèle un tableau mixte aphasie et atteinte cognitive, l'article sur le [CRBO en trouble cognitivo-linguistique](/crbo-trouble-cognitivo-linguistique/) précise comment distinguer les deux et structurer la conclusion en conséquence.

<aside class="essentiel">
  <div class="essentiel-label">L'essentiel</div>
  <ul>
    <li><strong>Diagnostic typologique :</strong> le CRBO d'aphasie post-AVC pose le type (Broca, Wernicke, conduction, anomique, transcorticale, globale), la sévérité, et rapporte l'étiologie transmise par le neurologue.</li>
    <li><strong>Batteries recommandées :</strong> MT-86 (référence libérale FR), DO-80 (manque du mot), BDAE (classification typologique), fluences verbales (accès lexical), BREF (dépistage exécutif).</li>
    <li><strong>Profil mixte :</strong> quand le profil ne correspond pas à un type isolé, le CRBO le nomme sans forcer la classification — reclassification prévue au bilan de renouvellement.</li>
    <li><strong>Opposabilité :</strong> depuis l'avenant 21, le CRBO n'est plus validé en amont par la CPAM — c'est le document qui porte seul la traçabilité du projet thérapeutique et sa justification.</li>
  </ul>
</aside>
...
La cotation AMO 30 (bilan cognitif et/ou neuropsychologique incluant le langage) s'applique en aphasie post-AVC. Elle donne droit à une enveloppe de 120 à 180 minutes de passation. L'arrêté du 25 juillet 2023 impose une structure en six sections obligatoires : anamnèse, observations cliniques, évaluation par axe, tests normés réalisés, conclusion diagnostique, projet thérapeutique. Toute omission (section manquante, scores sans interprétation, diagnostic en creux) constitue un risque documentaire lors du contrôle.

<div class="callout callout-info">
  <div class="callout-icon">i</div>
  <div class="callout-body">
    <div class="callout-title">Recommandations HAS</div>
    <p>La Haute Autorité de Santé recommande une prise en charge orthophonique précoce en aphasie post-AVC, en phase subaiguë (à partir de 4 à 6 semaines), à raison de 2 à 5 séances hebdomadaires selon la sévérité. Le bilan initial en libéral intervient généralement après retour à domicile, pour documenter le profil post-hospitalisation et fonder la poursuite de la rééducation. (Source : <a href="https://has-sante.fr" target="_blank">has-sante.fr</a>, recommandations 2020)</p>
  </div>
</div>
...
<div class="cta">
  ...
  <h3 class="cta-h">Votre CRBO d'aphasie, structuré et conforme, en 30 minutes au lieu de 3 heures.</h3>
  <p class="cta-p">Trame conforme 2023, OCR des étalonnages MT-86 et DO-80, dictée vocale Whisper, génération IA fidèle aux données. Vous validez, vous signez.</p>
  <a href="https://ortho-ia.com/ressources/crbo-aphasie" class="cta-btn">Voir le modèle complet →</a>
</div>

---

## FAQ : questions fréquentes sur le CRBO aphasie
...
- Recommandations HAS sur la prise en charge orthophonique après AVC : [has-sante.fr](https://has-sante.fr)
- Nomenclature de la FNO et texte de l'avenant 20 : [fno.fr](https://orthophonistes.fr)
- Fédération Nationale des Aphasiques de France, pour l'orientation des patients et des aidants : [aphasie.fr](https://aphasie.fr)

**[Voir le modèle complet](https://ortho-ia.com/ressources/crbo-aphasie)**
