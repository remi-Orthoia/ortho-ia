...
const PERCENTILE_OPTIONS: Array<{
  ...
  { key: 'p_90_95',  label: 'P90 — P95', zone: 'excellent',         chip: 'bg-emerald-600', text: 'text-white' },
  { key: 'p_75_90',  label: 'P75 — P90', zone: 'excellent',         chip: 'bg-emerald-500', text: 'text-white' },
  ...
  { key: 'p_10_25',  label: 'P10 — P25', zone: 'fragilite',         chip: 'bg-orange-300',  text: 'text-orange-900' },
  { key: 'p_5_10',   label: 'P5 — P10',  zone: 'difficulte',        chip: 'bg-orange-500',  text: 'text-white' },
