...
export const BUILTIN_GLOSSARY: ReadonlyArray<Omit<GlossaireEntry, 'id' | 'createdAt'>> = [
  ...
  { term: 'GEVASCO', aliases: ['gevasco', 'gévasco', 'gé vasco', 'g e v a s c o', 'G.E.V.A.S.C.O'], category: 'acronyme' },
  { term: 'PIAL', aliases: ['p i a l', 'P.I.A.L', 'pi al', 'pial'], category: 'acronyme' },
  { term: 'ESS', aliases: ['e s s', 'E.S.S', 'è s s'], category: 'acronyme' },
  { term: 'ESMS', aliases: ['e s m s', 'E.S.M.S', 'è s m s'], category: 'acronyme' },
  { term: 'CDAPH', aliases: ['c d a p h', 'C.D.A.P.H', 'cédaph'], category: 'acronyme' },
  { term: 'GEVA', aliases: ['g e v a', 'G.E.V.A', 'géva'], category: 'acronyme' },
  { term: 'CNSA', aliases: ['c n s a', 'C.N.S.A'], category: 'acronyme' },
  { term: 'HAS', aliases: ['h a s', 'H.A.S', 'hache as'], category: 'acronyme' },
  ...
  { term: 'MoCA', aliases: ['moca', 'Moca', 'mauca', 'mo ka', 'm o c a'], category: 'test' },
  { term: 'BIA', aliases: ['b i a', 'B.I.A', 'bi a'], category: 'test' },
  { term: 'BECD', aliases: ['b e c d', 'B.E.C.D', 'bé é cé dé', 'bé cé dé'], category: 'test' },
  { term: 'BALE', aliases: ['b a l e', 'B.A.L.E'], category: 'test' },
  { term: 'N-EEL', aliases: ['n e e l', 'N.E.E.L', 'n-e-e-l', 'né èl', 'néel'], category: 'test' },
  { term: 'BILO', aliases: ['b i l o', 'B.I.L.O', 'bilô'], category: 'test' },
  { term: 'PREDIMEM', aliases: ['predimem', 'Predimem', 'prédi mem', 'prédimem', 'prédi-mem'], category: 'test' },
  { term: 'PrediFex', aliases: ['predifex', 'Predifex', 'prédi fex', 'prédifex', 'prédi-fex'], category: 'test' },
  { term: 'PrediLac', aliases: ['predilac', 'Predilac', 'prédi lac', 'prédilac', 'prédi-lac'], category: 'test' },
  { term: 'B-CM', aliases: ['b c m', 'bécèm', 'B.C.M', 'bcm'], category: 'test' },
  { term: 'B-CMado', aliases: ['b c m ado', 'bécèm ado', 'bcm ado', 'B-C-M ado'], category: 'test' },
  { term: 'GreMots', aliases: ['gremot', 'Gremot', 'gré mots', 'GreMot', 'gremots'], category: 'test' },
  ...
  { term: 'TSLA', aliases: ['t s l a', 'T.S.L.A', 'téssèla'], category: 'clinique' },
  { term: 'TDC', aliases: ['t d c', 'T.D.C', 'tédécé'], category: 'clinique' },
  { term: 'TND', aliases: ['t n d', 'T.N.D', 'téendé'], category: 'clinique' },
  { term: 'fluence', aliases: ['fluance', 'fluences'], category: 'clinique' },
  { term: 'inférence', aliases: ['inferance', 'inférance'], category: 'clinique' },
  { term: 'inférences', aliases: ['inferances', 'inférances'], category: 'clinique' },
  { term: 'neurodéveloppemental', aliases: ['neuro développemental', 'neuro-développemental', 'neuro developpemental'], category: 'clinique' },
  { term: 'neurodéveloppementale', aliases: ['neuro développementale', 'neuro-développementale'], category: 'clinique' },
  { term: 'transcodage', aliases: ['trans codage', 'trans-codage'], category: 'clinique' },
  { term: 'graphème', aliases: ['gra phème', 'gra-phème'], category: 'clinique' },
  { term: 'morphème', aliases: ['mor phème', 'mor-phème'], category: 'clinique' },
  { term: 'phonème', aliases: ['fo nème', 'phonem'], category: 'clinique' },
  { term: 'lexique orthographique', aliases: ['lexique ortho graphique'], category: 'clinique' },
  { term: 'conscience phonologique', aliases: ['conscience fonologique', 'conscience phono logique'], category: 'clinique' },
  { term: 'mémoire de travail', aliases: ['memoire de travail', 'mémoire-de-travail'], category: 'clinique' },
  { term: 'boucle phonologique', aliases: ['boucle fonologique', 'boucle phono logique'], category: 'clinique' },
  { term: 'calepin visuo-spatial', aliases: ['calepin visuo spatial', 'calepin visuospatial'], category: 'clinique' },
  { term: 'denomination', aliases: ['déno mination', 'dénomi nation'], category: 'clinique' },
  { term: 'logatome', aliases: ['logatomes', 'logato', 'logatôme'], category: 'clinique' },
  { term: 'logatomes', aliases: ['logato me', 'logatômes'], category: 'clinique' },
  { term: 'pseudomot', aliases: ['pseudo mot', 'pseudo-mot'], category: 'clinique' },
  { term: 'pseudomots', aliases: ['pseudo mots', 'pseudo-mots'], category: 'clinique' },
]
