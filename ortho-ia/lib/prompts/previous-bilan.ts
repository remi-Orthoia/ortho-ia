    ...
    properties: {
      ...
      domains: {
        ...
        description:
          ...
          "percentile_value=null. Respecter la grille 6 zones d'interprétation (refonte 2026-05-ter).",
        items: {
          type: 'object',
                ...
                properties: {
                  ...
                  interpretation: {
                    ...
                    description:
                      ...
                      "'Excellent' (P76-100), 'Moyenne haute' (P50-P75, Q3 inclus), " +
                      "'Moyenne basse' (P26-P49), 'Zone de fragilité' (P11-P25, Q1 inclus), " +
                      "'Difficulté' (P6-P10), 'Difficulté sévère' (P1-P5 — Exalang " +
                      "n'affiche jamais <P5).",
                  },
                },
              },
...
6. **Conversion quartiles** (HappyNeuron / Exalang) :
   - Q1 → percentile_value = 25, interpretation = "Zone de fragilité"
   - Med / Q2 → 50 / "Moyenne haute"
   - Q3 → 75 / "Moyenne haute"
...
5. **Q1 = P25 = "Zone de fragilité"**. Med = P50 = "Moyenne haute" (P50-P75 inclus). Q3 = P75 = "Moyenne haute".
