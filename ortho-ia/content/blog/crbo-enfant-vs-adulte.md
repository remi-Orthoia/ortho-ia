...
slug: crbo-enfant-vs-adulte
canonicalSlug: crbo-enfant-vs-adulte
locale: fr
...
author: Ortho.ia
coverImage: /blog-covers/crbo-enfant-vs-adulte.png
coverAlt: >-
...
1. **Anamnèse** : motif de consultation, antécédents médicaux et développementaux, contexte familial et scolaire ou professionnel.
2. **Observations cliniques** : comportement spontané, communication observée avant l'évaluation formelle.
3. **Évaluation par axe** : phonologie, lexique, morphosyntaxe, pragmatique, fluence (langage oral) ; décodage, orthographe, compréhension (langage écrit) ; fonctions exécutives, mémoire (cognition).
4. **Tests normés réalisés** : tableau avec notes brutes, notes étalonnées, interprétation (déficit, fragile, norme).
5. **Conclusion diagnostique** : diagnostic posé (TDL, dyslexie, aphasie…), sévérité, axes touchés.
6. **Projet thérapeutique** : objectifs prioritaires, modalités (fréquence, durée estimée), coordination pluridisciplinaire.
...
- **AMO 30** (60 €) : bilan initial enfant ou adulte, toutes pathologies confondues, durée 2 h à 5 h.
- Coté une seule fois par patient et par pathologie. Si deux pathologies distinctes (ex : dyslexie + bégaiement), deux bilans initiaux peuvent être réalisés à plusieurs mois d'intervalle.

### Bilan de renouvellement

- **AMO 30** (60 €) : bilan complet de renouvellement, administré après 12 à 18 mois de rééducation pour justifier la poursuite de la prise en charge.
- Depuis 2024, un **bilan de renouvellement tous les 18 mois minimum** est exigé par l'Assurance Maladie pour les prises en charge longues (TDL, dyslexie, aphasie post-AVC).

### AMO 24 (bilan de renouvellement simplifié)

- **AMO 24** (36 €) : introduit en janvier 2024, coté pour un bilan de renouvellement allégé (1 h à 1 h 30), sans réadministration complète des batteries, centré sur la réévaluation des objectifs thérapeutiques.
...
1. **Anamnèse développementale excessive** : "Premiers mots à 12 mois, premières phrases à 2 ans" n'a aucune pertinence clinique pour un homme de 68 ans aphasique post-AVC. Focaliser sur l'événement neurologique.
2. **Absence de volet cognitif** : un bilan adulte sans évaluation de la mémoire de travail, de l'attention, ou des fonctions exécutives est incomplet. Même si le motif est "manque du mot", testez la cognition.
3. **Restitution infantilisante** : "Ne vous inquiétez pas, on va y arriver ensemble" sonne paternaliste. Un adulte attend une restitution factuelle, avec des données chiffrées et un projet thérapeutique co-construit.
4. **Tests pédiatriques inadaptés** : administrer l'EVALO 2-6 à un adulte n'a aucun sens (pas d'étalonnage, épreuves trop simples). Utiliser MT86, BDAE, GREMOTS.

### Erreurs fréquentes sur CRBO enfant

1. **Anamnèse trop succincte** : "Grossesse normale, développement dans la norme" en une ligne ne suffit pas. Détaillez les étapes psychomotrices, les antécédents ORL, la vérification audiologique.
2. **Absence de volet pragmatique** : un enfant peut avoir un lexique et une morphosyntaxe dans la norme, mais des fragilités pragmatiques (TSA, trouble du langage pragmatique). Toujours évaluer la pragmatique.
...
Pour aller plus loin, consultez le [modèle de CRBO Word/PDF téléchargeable](https://ortho-ia.com/blog/theme/redaction-crbo/modele-crbo-word-pdf) qui détaille la mise en forme et les formulations diagnostiques types.
