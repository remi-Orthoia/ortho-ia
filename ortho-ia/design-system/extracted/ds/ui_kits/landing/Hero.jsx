const Hero = () => (
  <section style={{ padding: '80px 0 96px', position: 'relative', overflow: 'hidden' }}>
    <Container style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: 64, alignItems: 'center' }}>
      <div>
        ...
        <div style={{ display: 'flex', gap: 12, marginTop: 32, alignItems: 'center' }}>
          <Button variant="primary" size="lg">Essayer gratuitement</Button>
        ...
        <p style={{
          fontSize: 13, color: 'var(--fg-3)', marginTop: 16,
        }}>
          Sans carte bancaire · 3 CRBO offerts · RGPD & secret médical · Hébergement HDS.
        </p>
      </div>
      ...
      <div style={{ position: 'relative' }}>
        <div style={{
          ...
          <div style={{ marginTop: 18, padding: '10px 14px', background: 'var(--success-soft)', color: 'var(--success)', borderRadius: 12, fontSize: 13, fontWeight: 500, display: 'inline-flex', alignItems: 'center', gap: 8 }}>
